...
type (
	KnownPeersResponse struct {
		...
		// ReportedUsingPeerID is what this peer says it is routing through.
		// Empty means the peer is not using an exit node.
		ReportedUsingPeerID   string
		ReportedUsingPeerName string
		LastSeen              time.Time
