...
KnownPeer _$KnownPeerFromJson(Map<String, dynamic> json) => KnownPeer(
  ...
  json['ReportedUsingPeerID'] as String? ?? '',
  json['ReportedUsingPeerName'] as String? ?? '',
...
Map<String, dynamic> _$KnownPeerToJson(KnownPeer instance) => <String, dynamic>{
  ...
  'ReportedUsingPeerID': instance.reportedUsingPeerID,
  'ReportedUsingPeerName': instance.reportedUsingPeerName,
