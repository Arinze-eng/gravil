...
func (h *Handler) getKnownPeers() []entity.KnownPeersResponse {
	...
	for _, peerID := range peers {
		...
		reportedUsingPeerID := knownPeer.ReportedUsingPeerID
		reportedUsingPeerName := ""
		if reportedUsingPeerID != "" {
			if p, ok := h.conf.GetPeer(reportedUsingPeerID); ok {
				reportedUsingPeerName = p.DisplayName()
			}
		}
		...
		kpr := entity.KnownPeersResponse{
			...
			ReportedUsingPeerID:    reportedUsingPeerID,
			ReportedUsingPeerName:  reportedUsingPeerName,
