...
//        });
        ...
        // VPN switch listener is set in onResume() to stay in sync with service state.
...
//        });
    ...
    protected void onResume() {
        ...
        try {
            ...
            // Update switch UI to reflect actual service state
            ...
            vpnSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    if (isChecked) {
                        Intent intent = VpnService.prepare(SettingsActivity.this);
                        if (intent != null) {
                        ...
                        Intent intent = new Intent(SettingsActivity.this, SSLVPNService.class);
                        stopService(intent);
                    }
                }
            });
...
@Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            Intent intent = new Intent(this, SSLVPNService.class);
            startService(intent);
        } else {
